...
export interface BillPrintHeaderProps {
    ...
    /** Pass "itNo" to show hospital GST, "salesTax" to show pharmacy GST, omit to hide */
    gstType?: "itNo" | "salesTax";
}

const BillPrintHeader: React.FC<BillPrintHeaderProps> = ({
    isReceipt,
    customBillType,
    ...
    const org = useSelector((state: RootState) => state.appReducer.organization);
    ...
    return (
        <>
            {/* ── Organisation header (logo + name + address + phone) ── */}
