...
import { payrollManagementMenuConfig, MenuItemConfig } from '../config/menu.config';
...
const Sidebar: React.FC<SidebarProps> = () => {
  ...
  useEffect(() => {
    if (collapsed) {
      ...
      setMenus([...payrollManagementMenuConfig.menus]);
    }
  }, [collapsed]);
    ...
    <>
      ...
      <div className={`module-sidebar ${collapsed ? 'collapsed' : ''} ${mobileOpen ? 'mobile-open' : ''}`}>
        ...
        <div className="sidebar-header">
            <h2 className="sidebar-header-title">Payroll Management</h2>
        </div>
