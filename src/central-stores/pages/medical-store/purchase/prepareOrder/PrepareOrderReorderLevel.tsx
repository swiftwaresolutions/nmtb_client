...
interface PrepareOrderReorderLevelProps {
  onBack?: () => void;
}

const PrepareOrderReorderLevel: React.FC<PrepareOrderReorderLevelProps> = ({ onBack }) => {
              ...
              <div className="row g-2 align-items-center mb-1">
                ...
                <div className="col-12 col-md-6">
                  ...
                  <Typeahead
                    ...
                    placeholder={loading ? "Loading medicines..." : "Search by Item Name"}
                    onChange={(selected) => setSelectedProduct(selected as ProductData[])}
                    selected={selectedProduct}
                    clearButton
                    highlightOnlyResult
                    disabled={loading}
                    emptyLabel={loading ? "Loading medicines..." : "No matches found"}
                ...
                <div className="col-12 col-md-2">
                  <button
                    ...
                    disabled={selectedProduct.length === 0 || loading}
                  >
...
export default PrepareOrderReorderLevel;
